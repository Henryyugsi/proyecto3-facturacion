...
public class Administrador {
    ...
    public Administrador( String RUC, String RazonSocial,String NombreComercial, String CorreElectronico, int telefono, String Direccion,String Ciudad, String TipoContribuyente, String Contabilidad, String UbicacionFirma, String ContraseñaFirmaElectronica) {
        this.RUC = RUC;
    ...
    public void añadir() {
        ...
        PreparedStatement psp = con.prepareStatement("INSERT INTO administrador (RUC,RAZONSOCIAL,NOMBRECOMERCIAL,CORREOELECTRONICO,TELEFONO,DIRECCIONMATRIZ,CIUDADMATRIZ,TIPOCONTRIBUYENTE,OBLIGADOCONTABILIDAD,FIRMAELECTRONICA,CONTRASEÑAFIRMAELECTRONICA) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
        psp.setString(1, RUC);
        ...
        String sql1 = "UPDATE administrador SET nombrecomercial=?, correoelectronico=?, telefono=?, direccionmatriz=?,ciudadmatriz=?, tipocontribuyente=?, obligadocontabilidad=?, firmaelectronica=?,contraseñafirmaelectronica=? WHERE RUC=?;";
