...
public class PDF {
     public String[] facturador= new String[6];
    ...
    protected void manipulatePdf(String dest, String[] dFacturador,String[] dFactura,String[] dComprador,String[] dfinales,int numeroproductos1, String[][] productos1) throws Exception {
        ...
        ImageData imageData = ImageDataFactory.create("C:\\Users\\henry\\Downloads\\prueba1.png");
        ...
        tableima.setFixedPosition(35, 655, 0);
        doc.add(tableima);
